    ...
    <div className="app__container">
      ...
      <div className="profile__details">
        ...
        <div className="box__page">
          ...
          <label className="label__block__details">Full Name : <span className="account__profile">{user?.firstName} {user?.lastName}</span></label>
          </div>
          <div className="label__block">
          <label className="label__block__details">Email Address : <span className="account__profile">{user?.email}</span></label>
          </div>
